...
import {LeftPanelPage} from "../left-panel/left-panel";
import {PreMonthSummaryPage} from "../pre-month-summary/pre-month-summary";
...
//         this.messageService.sendMHChartArray(data.monthcomptotal);
  ...
  toLastMonthSummary() {
    this.navCtrl.push(PreMonthSummaryPage,{token: this.token, prev_monthTotal: this.prev_monthTotal})
  }
