...
// /**
//  * Generated class for the MdChartComponent component.
//  *
//  * See https://angular.io/docs/ts/latest/api/core/index/ComponentMetadata-class.html
//  * for more info on Angular Components.
//  */
// @Component({
//   selector: 'md-chart-min',
//   templateUrl: 'md-chart.html'
// })
// export class MdChartMinComponent {
//
//   daychart = [];
//   dataArray=[];
//   labelsArray=[];
...
//     { // grey
//       backgroundColor: 'rgba(233,109,87,0.05)',
...
//
//
//     this.messageService.getMDChartArray().subscribe(message => {
//
//      // this.ven_mdchart_dataset = message.mdchart;
//       console.log(message);
//
//       this.daychart = message.mdchart;
//
//
//       this.dataArray=[];
//       this.labelsArray=[];
